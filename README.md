...
python -m piper.train fit \
  ...
  --ckpt_path "./lightning_logs/version_13/checkpoints/epoch=10810-step=28290.ckpt"
```

> El fine-tuning se realizó durante **~810 épocas adicionales** sobre el checkpoint pre-entrenado, con precisión mixta `bf16` para optimizar el uso de memoria y la velocidad de entrenamiento.
